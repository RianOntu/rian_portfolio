...
const Banner = () => {
    return (
        <div className='container banner' id="home">
          <div className="flex banner_inner align-items-center">
              <div className="description large_width">
                <h1 className='text-white'><span style={{fontSize:'20px',fontWeight:400,color:'#326BD3',fontFamily:"monospace"}}>Hi,I am <span class="waving-hand">👋</span></span> <br /> <span className='name' style={{fontFamily:"sans-serif",fontWeight:"800",color:"#CCD6F6",lineHeight:"2",fontSize:'40px'}}>RIAN-AL-NUR</span><br />

                <span style={{color:"#8892B0",fontSize:'40px',fontWeight:"800"}}>
                <Typewriter
            words={['Frontend Dev', 'React Dev', 'Web Dev']}
            loop={true}
            cursor
            cursorStyle='_'
            typeSpeed={100}
